...
@NgModule({
  ...
  ValidationErrorsComponent, ProjectDetailComponent, ProjectDetailContainerComponent],
  imports: [CommonModule,ProjectsRoutingModule, ReactiveFormsModule, SharedModule],
